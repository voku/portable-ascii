...
final class ASCII
{
    ...
    /**
     * Returns the replacements array for ASCII method.
     *
     * @return array{orig: string[], replace: string[]}
     *                     <p>An array of replacements.</p>
     */
    public static function charsArrayWithSingleLanguageValues(): array
    {
        // init
        static $CHARS_ARRAY = [];
        ...
        $CHARS_ARRAY = \array_merge([], ...$CHARS_ARRAY);
    ...
    /**
     * Returns the replacements for ASCII method.
     *
     * @return array
     *               <p>An array of replacements.</p>
     */
    public static function charsArrayWithMultiLanguageValues(): array
    {
        static $CHARS_ARRAY;
        ...
        // init
        $return = [];
        $returnTmp = self::charsArrayWithSingleLanguageValues();
    ...
    /**
     * Returns language-specific replacements for ASCII method.
     *
     ...
     *                     <p>An array of replacements.</p>
     */
    public static function charsArrayWithOneLanguage(string $language = 'en'): array
    {
        ...
        if (isset(self::$ASCII_MAPS[$language])) {
            $CHARS_ARRAY[$language] = [
                'orig'    => \array_keys(self::$ASCII_MAPS[$language]),
                'replace' => \array_values(self::$ASCII_MAPS[$language]),
            ];
        } else {
            $CHARS_ARRAY[$language] = [
                'orig'    => '',
