...
*   Current CI covers modern PHP 8.x releases as well
...
<p id="voku-php-readme-class-methods"></p><table><tr><td><a href="#charsarraybool-replace_extra_symbols">charsArray</a>
</td><td><a href="#charsarraywithmultilanguagevaluesbool-replace_extra_symbols-arraystringliststring">charsArrayWithMultiLanguageValues</a>
...
</td><td><a href="#to_asciistring-str-string-language-bool-remove_unsupported_chars-bool-replace_extra_symbols-bool-use_transliterate-bool-replace_single_chars_only-string">to_ascii</a>
</td><td><a href="#to_ascii_remapstring-str1-string-str2">to_ascii_remap</a>
...
#### charsArrayWithMultiLanguageValues(bool $replace_extra_symbols): array<string,list<string>>
<a href="#voku-php-readme-class-methods">↑</a>
...
**Return:**
- `array<string,list<string>> <p>An array of replacements.</p>`
...
**Parameters:**
- `ASCII::*_LANGUAGE_CODE $language [optional] <p>Language of the source string e.g.: en, de_at, or de-ch.
(default is 'en') | ASCII::*_LANGUAGE_CODE</p>`
- `bool $replace_extra_symbols [optional] <p>Add some more replacements e.g. "£" with " pound ".</p>`
- `bool $asOrigReplaceArray [optional] <p>TRUE === return {orig: list<string>, replace: list<string>}
array</p>`
...
**Return:**
- `array<string,string> <p>An associative array where the key is the language code in lowercase
...
#### to_ascii(string $str, string $language, bool $remove_unsupported_chars, bool $replace_extra_symbols, bool $use_transliterate, bool $replace_single_chars_only): string
<a href="#voku-php-readme-class-methods">↑</a>
...
- `ASCII::*_LANGUAGE_CODE $language [optional] <p>Language of the source string.
(default is 'en') | ASCII::*_LANGUAGE_CODE</p>`
- `bool $remove_unsupported_chars [optional] <p>Whether to remove the
...
- `bool $replace_single_chars_only [optional]  <p>Single char replacement is better for the
...
#### to_ascii_remap(string $str1, string $str2): 
<a href="#voku-php-readme-class-methods">↑</a>
...
**Parameters:**
- `string $str <p>The string input.</p>`
...
- `string $fallback_char <p>The fallback character. - "-" is the default</p>`
...
**Return:**
- `string <p>The URL-friendly slug.</p>`
